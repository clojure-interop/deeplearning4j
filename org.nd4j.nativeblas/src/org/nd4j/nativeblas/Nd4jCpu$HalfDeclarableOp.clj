(ns org.nd4j.nativeblas.Nd4jCpu$HalfDeclarableOp
  (:refer-clojure :only [require comment defn ->])
  (:import [org.nd4j.nativeblas Nd4jCpu$HalfDeclarableOp]))
...
(defn ->half-declarable-op
  ...
  (^Nd4jCpu$HalfDeclarableOp [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$HalfDeclarableOp p)))

(defn validate-orders-match
  "block - `org.nd4j.nativeblas.Nd4jCpu$HalfContext`

  returns: `(value="Nd4jStatus")  int`"
  ([^Nd4jCpu$HalfDeclarableOp this ^org.nd4j.nativeblas.Nd4jCpu$HalfContext block]
...
(defn calculate-output-shape
  ...
  (^org.nd4j.nativeblas.Nd4jCpu$ShapeList [^Nd4jCpu$HalfDeclarableOp this ^org.nd4j.nativeblas.Nd4jCpu$ShapeList input-shape ^org.nd4j.nativeblas.Nd4jCpu$HalfContext block]
...
(defn validate-input-dimensions
  ...
  returns: `(value="Nd4jStatus")  int`"
  ([^Nd4jCpu$HalfDeclarableOp this ^org.nd4j.nativeblas.Nd4jCpu$HalfContext block ^Integer rank]
    (-> this (.validateInputDimensions block rank))))

(defn get-op-descriptor
  "returns: `org.nd4j.nativeblas.Nd4jCpu$OpDescriptor`"
  (^org.nd4j.nativeblas.Nd4jCpu$OpDescriptor [^Nd4jCpu$HalfDeclarableOp this]
