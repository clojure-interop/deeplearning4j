(ns org.nd4j.nativeblas.Nd4jCuda$FloatDeclarableOp
  ...
  (:import [org.nd4j.nativeblas Nd4jCuda$FloatDeclarableOp]))
...
(defn ->float-declarable-op
  ...
  (^Nd4jCuda$FloatDeclarableOp [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCuda$FloatDeclarableOp p)))

(defn validate-orders-match
  "block - `org.nd4j.nativeblas.Nd4jCuda$FloatContext`

  returns: `(value="Nd4jStatus")  int`"
  ([^Nd4jCuda$FloatDeclarableOp this ^org.nd4j.nativeblas.Nd4jCuda$FloatContext block]
...
(defn calculate-output-shape
  ...
  (^org.nd4j.nativeblas.Nd4jCuda$ShapeList [^Nd4jCuda$FloatDeclarableOp this ^org.nd4j.nativeblas.Nd4jCuda$ShapeList input-shape ^org.nd4j.nativeblas.Nd4jCuda$FloatContext block]
...
(defn validate-input-dimensions
  ...
  returns: `(value="Nd4jStatus")  int`"
  ([^Nd4jCuda$FloatDeclarableOp this ^org.nd4j.nativeblas.Nd4jCuda$FloatContext block ^Integer rank]
    (-> this (.validateInputDimensions block rank))))

(defn get-op-descriptor
  "returns: `org.nd4j.nativeblas.Nd4jCuda$OpDescriptor`"
  (^org.nd4j.nativeblas.Nd4jCuda$OpDescriptor [^Nd4jCuda$FloatDeclarableOp this]
...
(defn get-op-hash
  ...
  ([^Nd4jCuda$FloatDeclarableOp this]
    (-> this (.getOpHash))))
