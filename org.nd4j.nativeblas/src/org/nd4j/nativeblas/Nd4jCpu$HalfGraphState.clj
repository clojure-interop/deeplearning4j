(ns org.nd4j.nativeblas.Nd4jCpu$HalfGraphState
  (:refer-clojure :only [require comment defn ->])
  (:import [org.nd4j.nativeblas Nd4jCpu$HalfGraphState]))
...
(defn ->half-graph-state
  ...
  (^Nd4jCpu$HalfGraphState [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$HalfGraphState p)))

(defn id
  "returns: `(value="Nd4jLong")  long`"
  ([^Nd4jCpu$HalfGraphState this]
    (-> this (.id))))
...
(defn register-scope
  ...
  ([^Nd4jCpu$HalfGraphState this ^Integer scope-id]
...
(defn attach-op-to-scope
  ...
  ([^Nd4jCpu$HalfGraphState this ^Long op-num ^Integer type ^org.nd4j.nativeblas.Nd4jCpu$ArgumentsList inputs]
...
(defn define-return
  ...
  returns: `(value="Nd4jStatus")  int`"
  ([^Nd4jCpu$HalfGraphState this ^Integer scope-id ^Integer node-id ^org.nd4j.nativeblas.Nd4jCpu$ArgumentsList args]
...
(defn variable-space
  ...
  (^org.nd4j.nativeblas.Nd4jCpu$HalfVariableSpace [^Nd4jCpu$HalfGraphState this]
    (-> this (.variableSpace))))
