(ns org.nd4j.nativeblas.Nd4jCpu$float_huber_loss
 ...
 Can be an array with the same shape as predictions or just single scalar, depending on reduction mode (see input integer argument)"
  ...
  (:import [org.nd4j.nativeblas Nd4jCpu$float_huber_loss]))

(defn ->float-huber-loss
  "Constructor.

  Pointer cast constructor. Invokes Pointer.Pointer(Pointer).

  p - `org.bytedeco.javacpp.Pointer`"
  (^Nd4jCpu$float_huber_loss [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$float_huber_loss p))
  (^Nd4jCpu$float_huber_loss []
    (new Nd4jCpu$float_huber_loss )))

(defn position
  "position - `long`

  returns: `org.nd4j.nativeblas.Nd4jCpu$float_huber_loss`"
  (^org.nd4j.nativeblas.Nd4jCpu$float_huber_loss [^Nd4jCpu$float_huber_loss this ^Long position]
...
(defn calculate-output-shape
  ...
  (^org.nd4j.nativeblas.Nd4jCpu$ShapeList [^Nd4jCpu$float_huber_loss this ^org.nd4j.nativeblas.Nd4jCpu$ShapeList input-shape ^org.nd4j.nativeblas.Nd4jCpu$FloatContext block]
