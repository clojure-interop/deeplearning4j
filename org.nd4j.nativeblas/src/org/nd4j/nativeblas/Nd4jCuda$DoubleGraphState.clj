(ns org.nd4j.nativeblas.Nd4jCuda$DoubleGraphState
  (:refer-clojure :only [require comment defn ->])
  (:import [org.nd4j.nativeblas Nd4jCuda$DoubleGraphState]))
...
(defn ->double-graph-state
  ...
  (^Nd4jCuda$DoubleGraphState [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCuda$DoubleGraphState p)))

(defn id
  "returns: `(value="Nd4jLong")  long`"
  ([^Nd4jCuda$DoubleGraphState this]
    (-> this (.id))))
...
(defn register-scope
  ...
  ([^Nd4jCuda$DoubleGraphState this ^Integer scope-id]
...
(defn attach-op-to-scope
  ...
  ([^Nd4jCuda$DoubleGraphState this ^Long op-num ^Integer type ^org.nd4j.nativeblas.Nd4jCuda$ArgumentsList inputs]
...
(defn define-return
  ...
  returns: `(value="Nd4jStatus")  int`"
  ([^Nd4jCuda$DoubleGraphState this ^Integer scope-id ^Integer node-id ^org.nd4j.nativeblas.Nd4jCuda$ArgumentsList args]
...
(defn variable-space
  ...
  (^org.nd4j.nativeblas.Nd4jCuda$DoubleVariableSpace [^Nd4jCuda$DoubleGraphState this]
    (-> this (.variableSpace))))
