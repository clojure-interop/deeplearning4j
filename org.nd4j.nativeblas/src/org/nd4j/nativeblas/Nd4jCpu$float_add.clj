(ns org.nd4j.nativeblas.Nd4jCpu$float_add
 ...
 This operation returns Z = Add(X, Y)"
  ...
  (:import [org.nd4j.nativeblas Nd4jCpu$float_add]))
...
(defn ->float-add
  ...
  (^Nd4jCpu$float_add [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$float_add p))
  (^Nd4jCpu$float_add []
    (new Nd4jCpu$float_add )))

(defn position
  "position - `long`

  returns: `org.nd4j.nativeblas.Nd4jCpu$float_add`"
  (^org.nd4j.nativeblas.Nd4jCpu$float_add [^Nd4jCpu$float_add this ^Long position]
