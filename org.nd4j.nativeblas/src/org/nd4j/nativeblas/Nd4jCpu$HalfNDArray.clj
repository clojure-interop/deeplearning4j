(ns org.nd4j.nativeblas.Nd4jCpu$HalfNDArray
  (:refer-clojure :only [require comment defn ->])
  (:import [org.nd4j.nativeblas Nd4jCpu$HalfNDArray]))
...
(defn ->half-nd-array
  ...
  (^Nd4jCpu$HalfNDArray [^org.bytedeco.javacpp.LongPointer shape-info ^org.nd4j.nativeblas.Nd4jCpu$Workspace workspace]
    (new Nd4jCpu$HalfNDArray shape-info workspace))
  (^Nd4jCpu$HalfNDArray [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$HalfNDArray p))
  (^Nd4jCpu$HalfNDArray []
    (new Nd4jCpu$HalfNDArray )))

(defn *create-empty
  "workspace - `org.nd4j.nativeblas.Nd4jCpu$Workspace`

  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^org.nd4j.nativeblas.Nd4jCpu$Workspace workspace]
    (Nd4jCpu$HalfNDArray/createEmpty workspace))
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray []
    (Nd4jCpu$HalfNDArray/createEmpty )))

(defn *value-of
  "value - `short`
  order - `char`

  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray valueOf((value="Nd4jLong*")  org.bytedeco.javacpp.LongPointer shape, @`"
  ([^Short value ^Character order]
    (Nd4jCpu$HalfNDArray/valueOf value order))
  ([^Short value]
    (Nd4jCpu$HalfNDArray/valueOf value)))

(defn *linspace
  "num-elements - `long`

  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray linspace((value="const float16") short from, (value="const float16") short to, @`"
  ([^Long num-elements]
    (Nd4jCpu$HalfNDArray/linspace num-elements)))

(defn *scalar
  "value - `short`

  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Short value]
    (Nd4jCpu$HalfNDArray/scalar value)))
...
(defn *quantize
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray array]
    (Nd4jCpu$HalfNDArray/quantize array)))

(defn has-infs
  "returns: `(value="bool")  boolean`"
  ([^Nd4jCpu$HalfNDArray this]
    (-> this (.hasInfs))))
...
(defn swap-unsafe
  ...
  other - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  ([^Nd4jCpu$HalfNDArray this ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray other]
...
(defn get-indexed-scalar
  ...
  returns: `(value="float16")  short`"
  ([^Nd4jCpu$HalfNDArray this ^Long i]
    (-> this (.getIndexedScalar i))))

(defn transp
  "returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this]
    (-> this (.transp))))
...
(defn enforce
  ...
  order - `char`"
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.LongPointer dimensions ^Character order]
    (-> this (.enforce dimensions order)))
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.LongPointer dimensions]
...
(defn assign
  ...
  ([^Nd4jCpu$HalfNDArray this ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray other ^org.nd4j.nativeblas.Nd4jCpu$Intervals idx]
...
(defn subarray
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this ^org.nd4j.nativeblas.Nd4jCpu$IndicesList indices]
...
(defn multiple-tensors-along-dimension
  ...
  (^org.nd4j.nativeblas.Nd4jCpu$HalfResultSet [^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.IntPointer indices ^org.bytedeco.javacpp.IntPointer dimensions]
...
(defn print-indexed-buffer
  ...
  ([^Nd4jCpu$HalfNDArray this ^Long limit]
...
(defn size-of-t
  ...
  returns: `int`"
  (^Integer [^Nd4jCpu$HalfNDArray this]
    (-> this (.sizeOfT))))
...
(defn tensors-along-dimension
  ...
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.IntPointer dimensions]
...
(defn addi-row-vector
  ...
  row - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  ([^Nd4jCpu$HalfNDArray this ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray row]
...
(defn cast
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this ^Integer dtype]
    (-> this (.cast dtype))))
...
(defn set-shape-info
  ...
  shape-info - `org.bytedeco.javacpp.LongPointer`"
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.LongPointer shape-info]
...
(defn set-value-in-diag-matrix
  ...
  diag - `int`
  direction - `char`"
  ([^Nd4jCpu$HalfNDArray this ^Short value ^Integer diag ^Character direction]
...
(defn permutei
  ...
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.IntPointer dimensions ^Integer rank]
...
(defn put-scalar
  ...
  ([^Nd4jCpu$HalfNDArray this ^Short value]
...
(defn tensor-along-dimension
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this ^Long index ^org.bytedeco.javacpp.IntPointer dimensions]
...
(defn as-indexed-string
  ...
  (^org.bytedeco.javacpp.BytePointer [^Nd4jCpu$HalfNDArray this ^Long limit]
    (-> this (.asIndexedString limit)))
  (^org.bytedeco.javacpp.BytePointer [^Nd4jCpu$HalfNDArray this]
...
(defn sum
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.IntPointer dimensions]
    (-> this (.sum dimensions))))
...
(defn repeat
  ...
  dimension - `int`
  target - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  ([^Nd4jCpu$HalfNDArray this ^Integer dimension ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray target]
    (-> this (.repeat dimension target)))
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.LongPointer repeats]
    (-> this (.repeat repeats))))
...
(defn linspace
  ...
  ([^Nd4jCpu$HalfNDArray this ^Short step]
    (-> this (.linspace step))))
...
(defn diagonal
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this ^Character type]
    (-> this (.diagonal type))))
...
(defn sub-row-vector
  ...
  row - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`
  target - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  ([^Nd4jCpu$HalfNDArray this ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray row ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray target]
...
(defn tile-to-shape
  ...
  target - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.LongPointer shape ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray target]
    (-> this (.tileToShape shape target)))
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.LongPointer shape]
...
(defn permute
  ...
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.IntPointer dimensions ^Integer rank ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray target]
    (-> this (.permute dimensions rank target)))
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.IntPointer dimensions ^Integer rank]
...
(defn addi-column-vector
  ...
  column - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  ([^Nd4jCpu$HalfNDArray this ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray column]
...
(defn ordering
  ...
  returns: `char`"
  (^Character [^Nd4jCpu$HalfNDArray this]
    (-> this (.ordering))))
...
(defn delete
  ...
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.Pointer p]
    (-> this (._delete p))))
...
(defn replace-pointers
  ...
  ([^Nd4jCpu$HalfNDArray this ^Boolean release-existing]
...
(defn apply
  ...
  returns: `(value="operator ()")  org.nd4j.nativeblas.Nd4jCpu$HalfNDArray apply(  org.nd4j.nativeblas.Nd4jCpu$Intervals idx, @`"
  ([^Nd4jCpu$HalfNDArray this ^Boolean keep-unities-in-shape]
...
(defn size-at
  ...
  returns: `(value="Nd4jLong")  long`"
  ([^Nd4jCpu$HalfNDArray this ^Integer dim]
    (-> this (.sizeAt dim))))
...
(defn reshape
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray reshape(char order, @`"
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.LongPointer shape]
    (-> this (.reshape shape))))
...
(defn position
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this ^Long position]
...
(defn tile
  ...
  target - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.LongPointer repeats ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray target]
    (-> this (.tile repeats target)))
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.LongPointer repeats]
    (-> this (.tile repeats))))
...
(defn broadcast
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray other]
...
(defn trigger-allocation-flag
  ...
  ([^Nd4jCpu$HalfNDArray this ^Boolean shape-allocated]
...
(defn has-orthonormal-basis
  ...
  returns: `(value="bool")  boolean`"
  ([^Nd4jCpu$HalfNDArray this ^Integer arg]
...
(defn set-buffer
  ...
  ([^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.ShortPointer buffer]
...
(defn all-tensors-along-dimension
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfResultSet`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfResultSet [^Nd4jCpu$HalfNDArray this ^org.bytedeco.javacpp.IntPointer dimensions]
...
(defn streamline
  ...
  order - `char`"
  ([^Nd4jCpu$HalfNDArray this ^Character order]
...
(defn add-column-vector
  ...
  column - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`
  target - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  ([^Nd4jCpu$HalfNDArray this ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray column ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray target]
...
(defn dup
  ...
  returns: `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this ^Character new-order]
    (-> this (.dup new-order)))
  (^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray [^Nd4jCpu$HalfNDArray this]
    (-> this (.dup))))
...
(defn all-examples
  "returns: `org.nd4j.nativeblas.Nd4jCpu$HalfResultSet`"
  (^org.nd4j.nativeblas.Nd4jCpu$HalfResultSet [^Nd4jCpu$HalfNDArray this]
    (-> this (.allExamples))))
...
(defn equals-to
  ...
  returns: `(value="bool")  boolean equalsTo( org.nd4j.nativeblas.Nd4jCpu$HalfNDArray other, @`"
  ([^Nd4jCpu$HalfNDArray this ^Short eps]
    (-> this (.equalsTo eps))))
...
(defn print-shape-info
  ...
  ([^Nd4jCpu$HalfNDArray this ^java.lang.String msg]
...
(defn transpose
  ...
  target - `org.nd4j.nativeblas.Nd4jCpu$HalfNDArray`"
  ([^Nd4jCpu$HalfNDArray this ^org.nd4j.nativeblas.Nd4jCpu$HalfNDArray target]
...
(defn get-workspace
  ...
  (^org.nd4j.nativeblas.Nd4jCpu$Workspace [^Nd4jCpu$HalfNDArray this]
    (-> this (.getWorkspace))))
