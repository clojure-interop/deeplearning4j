(ns onnx.OnnxMlProto3$GraphProtoOrBuilder
  (:refer-clojure :only [require comment defn ->])
  (:import [onnx OnnxMlProto3$GraphProtoOrBuilder]))
...
(defn get-initializer-or-builder
  ...
  (^onnx.OnnxMlProto3$TensorProtoOrBuilder [^OnnxMlProto3$GraphProtoOrBuilder this ^Integer index]
...
(defn get-doc-string-bytes
  ...
  (^com.github.os72.protobuf351.ByteString [^OnnxMlProto3$GraphProtoOrBuilder this]
...
(defn get-node-count
  ...
  returns: `int`"
  (^Integer [^OnnxMlProto3$GraphProtoOrBuilder this]
    (-> this (.getNodeCount))))
...
(defn get-output-or-builder
  ...
  (^onnx.OnnxMlProto3$ValueInfoProtoOrBuilder [^OnnxMlProto3$GraphProtoOrBuilder this ^Integer index]
...
(defn get-node
  ...
  (^onnx.OnnxMlProto3$NodeProto [^OnnxMlProto3$GraphProtoOrBuilder this ^Integer index]
    (-> this (.getNode index))))
...
(defn get-input-list
  ...
  (^java.util.List [^OnnxMlProto3$GraphProtoOrBuilder this]
    (-> this (.getInputList))))
...
(defn get-doc-string
  ...
  (^java.lang.String [^OnnxMlProto3$GraphProtoOrBuilder this]
    (-> this (.getDocString))))
...
(defn get-node-or-builder
  ...
  (^onnx.OnnxMlProto3$NodeProtoOrBuilder [^OnnxMlProto3$GraphProtoOrBuilder this ^Integer index]
...
(defn get-input
  ...
  (^onnx.OnnxMlProto3$ValueInfoProto [^OnnxMlProto3$GraphProtoOrBuilder this ^Integer index]
    (-> this (.getInput index))))
...
(defn get-initializer
  ...
  (^onnx.OnnxMlProto3$TensorProto [^OnnxMlProto3$GraphProtoOrBuilder this ^Integer index]
...
(defn get-input-or-builder-list
  ...
  ([^OnnxMlProto3$GraphProtoOrBuilder this]
