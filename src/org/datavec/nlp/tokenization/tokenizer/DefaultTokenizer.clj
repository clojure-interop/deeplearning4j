(ns org.datavec.nlp.tokenization.tokenizer.DefaultTokenizer
  "Default tokenizer"
...
(defn set-token-pre-processor
  ...
  ([^DefaultTokenizer this ^org.datavec.nlp.tokenization.tokenizer.TokenPreProcess token-pre-processor]
