(ns org.datavec.api.records.reader.impl.transform.TransformProcessSequenceRecordReader
  "This wraps a SequenceRecordReader with a TransformProcess
...
(defn ->transform-process-sequence-record-reader
  "Constructor."
  (^TransformProcessSequenceRecordReader []
    (new TransformProcessSequenceRecordReader )))
...
(defn load-sequence-from-meta-data
  ...
  (^org.datavec.api.records.SequenceRecord [^TransformProcessSequenceRecordReader this ^org.datavec.api.records.metadata.RecordMetaData record-meta-data]
...
(defn next
  ...
  (^java.util.List [^TransformProcessSequenceRecordReader this ^Integer num]
    (-> this (.next num)))
  (^java.util.List [^TransformProcessSequenceRecordReader this]
    (-> this (.next))))
...
(defn set-conf
  ...
  ([^TransformProcessSequenceRecordReader this ^org.datavec.api.conf.Configuration conf]
    (-> this (.setConf conf))))
...
(defn next-sequence
  ...
  (^org.datavec.api.records.SequenceRecord [^TransformProcessSequenceRecordReader this]
    (-> this (.nextSequence))))
...
(defn get-conf
  ...
  (^org.datavec.api.conf.Configuration [^TransformProcessSequenceRecordReader this]
    (-> this (.getConf))))
...
(defn record
  ...
  (^java.util.List [^TransformProcessSequenceRecordReader this ^java.net.URI uri ^java.io.DataInputStream data-input-stream]
    (-> this (.record uri data-input-stream))))

(defn reset
  "Reset record reader iterator"
  ([^TransformProcessSequenceRecordReader this]
    (-> this (.reset))))
...
(defn next-record
  ...
  (^org.datavec.api.records.Record [^TransformProcessSequenceRecordReader this]
    (-> this (.nextRecord))))
...
(defn batches-supported
  ...
  returns: `boolean`"
  (^Boolean [^TransformProcessSequenceRecordReader this]
...
(defn set-listeners
  ...
  ([^TransformProcessSequenceRecordReader this ^org.datavec.api.records.listener.RecordListener listeners]
...
(defn load-from-meta-data
  ...
  throws: java.io.IOException - If I/O error occurs during loading"
  (^org.datavec.api.records.Record [^TransformProcessSequenceRecordReader this ^org.datavec.api.records.metadata.RecordMetaData record-meta-data]
...
(defn initialize
  ...
  ([^TransformProcessSequenceRecordReader this ^org.datavec.api.conf.Configuration conf ^org.datavec.api.split.InputSplit split]
    (-> this (.initialize conf split)))
  ([^TransformProcessSequenceRecordReader this ^org.datavec.api.split.InputSplit split]
