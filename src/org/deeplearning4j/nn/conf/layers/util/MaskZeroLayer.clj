(ns org.deeplearning4j.nn.conf.layers.util.MaskZeroLayer
...
(defn ->mask-zero-layer
  ...
  (^MaskZeroLayer [^org.deeplearning4j.nn.conf.layers.Layer underlying]
...
(defn get-pre-processor-for-input-type
  ...
  (^org.deeplearning4j.nn.conf.InputPreProcessor [^MaskZeroLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn pretrain-param?
  ...
  (^Boolean [^MaskZeroLayer this ^java.lang.String param-name]
    (-> this (.isPretrainParam param-name))))

(defn to-string
  "returns: `java.lang.String`"
  (^java.lang.String [^MaskZeroLayer this]
    (-> this (.toString))))
...
(defn get-memory-report
  ...
  (^org.deeplearning4j.nn.conf.memory.LayerMemoryReport [^MaskZeroLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn set-n-in
  ...
  ([^MaskZeroLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type ^Boolean override]
...
(defn get-output-type
  ...
  (^org.deeplearning4j.nn.conf.inputs.InputType [^MaskZeroLayer this ^Integer layer-index ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn get-l-2-by-param
  ...
  (^Double [^MaskZeroLayer this ^java.lang.String param-name]
...
(defn instantiate
  ...
  (^org.deeplearning4j.nn.api.Layer [^MaskZeroLayer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^java.util.Collection training-listeners ^Integer layer-index ^org.nd4j.linalg.api.ndarray.INDArray layer-params-view ^Boolean initialize-params]
