(ns org.deeplearning4j.nn.conf.layers.ZeroPadding3DLayer
...
(defn get-pre-processor-for-input-type
  ...
  (^org.deeplearning4j.nn.conf.InputPreProcessor [^ZeroPadding3DLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn initializer
  ...
  (^org.deeplearning4j.nn.api.ParamInitializer [^ZeroPadding3DLayer this]
    (-> this (.initializer))))
...
(defn pretrain-param?
  ...
  (^Boolean [^ZeroPadding3DLayer this ^java.lang.String param-name]
...
(defn get-memory-report
  ...
  (^org.deeplearning4j.nn.conf.memory.LayerMemoryReport [^ZeroPadding3DLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn set-n-in
  ...
  ([^ZeroPadding3DLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type ^Boolean override]
...
(defn get-output-type
  ...
  (^org.deeplearning4j.nn.conf.inputs.InputType [^ZeroPadding3DLayer this ^Integer layer-index ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn get-l-2-by-param
  ...
  (^Double [^ZeroPadding3DLayer this ^java.lang.String param-name]
...
(defn instantiate
  ...
  (^org.deeplearning4j.nn.api.Layer [^ZeroPadding3DLayer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^java.util.Collection iteration-listeners ^Integer layer-index ^org.nd4j.linalg.api.ndarray.INDArray layer-params-view ^Boolean initialize-params]
