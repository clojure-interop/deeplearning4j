(ns org.deeplearning4j.nn.conf.layers.BatchNormalization
...
(defn get-pre-processor-for-input-type
  ...
  (^org.deeplearning4j.nn.conf.InputPreProcessor [^BatchNormalization this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn initializer
  ...
  (^org.deeplearning4j.nn.api.ParamInitializer [^BatchNormalization this]
    (-> this (.initializer))))
...
(defn pretrain-param?
  ...
  (^Boolean [^BatchNormalization this ^java.lang.String param-name]
...
(defn get-updater-by-param
  ...
  (^org.nd4j.linalg.learning.config.IUpdater [^BatchNormalization this ^java.lang.String param-name]
...
(defn get-memory-report
  ...
  (^org.deeplearning4j.nn.conf.memory.LayerMemoryReport [^BatchNormalization this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn set-n-in
  ...
  ([^BatchNormalization this ^org.deeplearning4j.nn.conf.inputs.InputType input-type ^Boolean override]
...
(defn get-output-type
  ...
  (^org.deeplearning4j.nn.conf.inputs.InputType [^BatchNormalization this ^Integer layer-index ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn get-l-2-by-param
  ...
  (^Double [^BatchNormalization this ^java.lang.String param-name]
...
(defn instantiate
  ...
  (^org.deeplearning4j.nn.api.Layer [^BatchNormalization this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^java.util.Collection training-listeners ^Integer layer-index ^org.nd4j.linalg.api.ndarray.INDArray layer-params-view ^Boolean initialize-params]
...
(defn clone
  ...
  (^org.deeplearning4j.nn.conf.layers.BatchNormalization [^BatchNormalization this]
    (-> this (.clone))))
