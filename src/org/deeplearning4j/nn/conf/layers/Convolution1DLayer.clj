(ns org.deeplearning4j.nn.conf.layers.Convolution1DLayer
...
(defn instantiate
  ...
  (^org.deeplearning4j.nn.api.Layer [^Convolution1DLayer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^java.util.Collection training-listeners ^Integer layer-index ^org.nd4j.linalg.api.ndarray.INDArray layer-params-view ^Boolean initialize-params]
...
(defn get-output-type
  ...
  (^org.deeplearning4j.nn.conf.inputs.InputType [^Convolution1DLayer this ^Integer layer-index ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn set-n-in
  ...
  ([^Convolution1DLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type ^Boolean override]
...
(defn get-pre-processor-for-input-type
  ...
  (^org.deeplearning4j.nn.conf.InputPreProcessor [^Convolution1DLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
