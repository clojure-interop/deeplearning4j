(ns org.deeplearning4j.nn.conf.layers.LSTM
...
(defn instantiate
  ...
  (^org.deeplearning4j.nn.api.Layer [^LSTM this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^java.util.Collection training-listeners ^Integer layer-index ^org.nd4j.linalg.api.ndarray.INDArray layer-params-view ^Boolean initialize-params]
...
(defn initializer
  ...
  (^org.deeplearning4j.nn.api.ParamInitializer [^LSTM this]
    (-> this (.initializer))))
...
(defn get-memory-report
  ...
  (^org.deeplearning4j.nn.conf.memory.LayerMemoryReport [^LSTM this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
