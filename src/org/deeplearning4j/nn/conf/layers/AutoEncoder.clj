(ns org.deeplearning4j.nn.conf.layers.AutoEncoder
  "Autoencoder.
...
(defn instantiate
  ...
  (^org.deeplearning4j.nn.api.Layer [^AutoEncoder this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^java.util.Collection training-listeners ^Integer layer-index ^org.nd4j.linalg.api.ndarray.INDArray layer-params-view ^Boolean initialize-params]
...
(defn initializer
  ...
  (^org.deeplearning4j.nn.api.ParamInitializer [^AutoEncoder this]
    (-> this (.initializer))))
...
(defn get-memory-report
  ...
  (^org.deeplearning4j.nn.conf.memory.LayerMemoryReport [^AutoEncoder this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
