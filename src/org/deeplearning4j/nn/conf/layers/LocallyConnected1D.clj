...
(defn get-output-type
  ...
  (^org.deeplearning4j.nn.conf.inputs.InputType [^LocallyConnected1D this ^Integer layer-index ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn set-n-in
  ...
  ([^LocallyConnected1D this ^org.deeplearning4j.nn.conf.inputs.InputType input-type ^Boolean override]
...
(defn get-pre-processor-for-input-type
  ...
  (^org.deeplearning4j.nn.conf.InputPreProcessor [^LocallyConnected1D this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn define-parameters
  ...
  ([^LocallyConnected1D this ^org.deeplearning4j.nn.conf.layers.samediff.SDLayerParams params]
...
(defn initialize-parameters
  ...
  ([^LocallyConnected1D this ^java.util.Map params]
...
(defn define-layer
  ...
  (^org.nd4j.autodiff.samediff.SDVariable [^LocallyConnected1D this ^org.nd4j.autodiff.samediff.SameDiff same-diff ^org.nd4j.autodiff.samediff.SDVariable layer-input ^java.util.Map param-table]
...
(defn apply-global-config-to-layer
  ...
  ([^LocallyConnected1D this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration$Builder global-config]
