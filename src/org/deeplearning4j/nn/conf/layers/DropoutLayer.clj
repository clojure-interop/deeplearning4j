(ns org.deeplearning4j.nn.conf.layers.DropoutLayer
...
(defn get-pre-processor-for-input-type
  ...
  (^org.deeplearning4j.nn.conf.InputPreProcessor [^DropoutLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn initializer
  ...
  (^org.deeplearning4j.nn.api.ParamInitializer [^DropoutLayer this]
    (-> this (.initializer))))
...
(defn pretrain-param?
  ...
  (^Boolean [^DropoutLayer this ^java.lang.String param-name]
...
(defn get-memory-report
  ...
  (^org.deeplearning4j.nn.conf.memory.LayerMemoryReport [^DropoutLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn set-n-in
  ...
  ([^DropoutLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type ^Boolean override]
...
(defn get-output-type
  ...
  (^org.deeplearning4j.nn.conf.inputs.InputType [^DropoutLayer this ^Integer layer-index ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn get-l-2-by-param
  ...
  (^Double [^DropoutLayer this ^java.lang.String param-name]
...
(defn instantiate
  ...
  (^org.deeplearning4j.nn.api.Layer [^DropoutLayer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^java.util.Collection training-listeners ^Integer layer-index ^org.nd4j.linalg.api.ndarray.INDArray layer-params-view ^Boolean initialize-params]
...
(defn clone
  ...
  (^org.deeplearning4j.nn.conf.layers.DropoutLayer [^DropoutLayer this]
    (-> this (.clone))))
