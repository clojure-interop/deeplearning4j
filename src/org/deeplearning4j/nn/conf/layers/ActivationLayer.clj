(ns org.deeplearning4j.nn.conf.layers.ActivationLayer
...
(defn ->activation-layer
  ...
  (^ActivationLayer [^org.nd4j.linalg.activations.Activation activation]
...
(defn get-pre-processor-for-input-type
  ...
  (^org.deeplearning4j.nn.conf.InputPreProcessor [^ActivationLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn initializer
  ...
  (^org.deeplearning4j.nn.api.ParamInitializer [^ActivationLayer this]
    (-> this (.initializer))))
...
(defn pretrain-param?
  ...
  (^Boolean [^ActivationLayer this ^java.lang.String param-name]
...
(defn get-memory-report
  ...
  (^org.deeplearning4j.nn.conf.memory.LayerMemoryReport [^ActivationLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn set-n-in
  ...
  ([^ActivationLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type ^Boolean override]
...
(defn get-output-type
  ...
  (^org.deeplearning4j.nn.conf.inputs.InputType [^ActivationLayer this ^Integer layer-index ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn get-l-2-by-param
  ...
  (^Double [^ActivationLayer this ^java.lang.String param-name]
...
(defn instantiate
  ...
  (^org.deeplearning4j.nn.api.Layer [^ActivationLayer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^java.util.Collection training-listeners ^Integer layer-index ^org.nd4j.linalg.api.ndarray.INDArray layer-params-view ^Boolean initialize-params]
...
(defn clone
  ...
  (^org.deeplearning4j.nn.conf.layers.ActivationLayer [^ActivationLayer this]
    (-> this (.clone))))
