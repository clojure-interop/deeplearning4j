(ns org.deeplearning4j.nn.conf.layers.ZeroPadding1DLayer
...
(defn ->zero-padding-1-d-layer
  ...
  pad-left - `int`
  pad-right - `int`"
  (^ZeroPadding1DLayer [^Integer pad-left ^Integer pad-right]
    (new ZeroPadding1DLayer pad-left pad-right))
  (^ZeroPadding1DLayer [^Integer padding]
    (new ZeroPadding1DLayer padding)))
...
(defn get-pre-processor-for-input-type
  ...
  (^org.deeplearning4j.nn.conf.InputPreProcessor [^ZeroPadding1DLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn initializer
  ...
  (^org.deeplearning4j.nn.api.ParamInitializer [^ZeroPadding1DLayer this]
    (-> this (.initializer))))
...
(defn pretrain-param?
  ...
  (^Boolean [^ZeroPadding1DLayer this ^java.lang.String param-name]
...
(defn get-memory-report
  ...
  (^org.deeplearning4j.nn.conf.memory.LayerMemoryReport [^ZeroPadding1DLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn set-n-in
  ...
  ([^ZeroPadding1DLayer this ^org.deeplearning4j.nn.conf.inputs.InputType input-type ^Boolean override]
...
(defn get-output-type
  ...
  (^org.deeplearning4j.nn.conf.inputs.InputType [^ZeroPadding1DLayer this ^Integer layer-index ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn get-l-2-by-param
  ...
  (^Double [^ZeroPadding1DLayer this ^java.lang.String param-name]
...
(defn instantiate
  ...
  (^org.deeplearning4j.nn.api.Layer [^ZeroPadding1DLayer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^java.util.Collection training-listeners ^Integer layer-index ^org.nd4j.linalg.api.ndarray.INDArray layer-params-view ^Boolean initialize-params]
