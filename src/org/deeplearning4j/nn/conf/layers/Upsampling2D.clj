(ns org.deeplearning4j.nn.conf.layers.Upsampling2D
  "Upsampling 2D layer"
...
(defn clone
  ...
  (^org.deeplearning4j.nn.conf.layers.Upsampling2D [^Upsampling2D this]
    (-> this (.clone))))
...
(defn instantiate
  ...
  (^org.deeplearning4j.nn.api.Layer [^Upsampling2D this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^java.util.Collection training-listeners ^Integer layer-index ^org.nd4j.linalg.api.ndarray.INDArray layer-params-view ^Boolean initialize-params]
...
(defn get-output-type
  ...
  (^org.deeplearning4j.nn.conf.inputs.InputType [^Upsampling2D this ^Integer layer-index ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn get-pre-processor-for-input-type
  ...
  (^org.deeplearning4j.nn.conf.InputPreProcessor [^Upsampling2D this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
...
(defn get-memory-report
  ...
  (^org.deeplearning4j.nn.conf.memory.LayerMemoryReport [^Upsampling2D this ^org.deeplearning4j.nn.conf.inputs.InputType input-type]
