(ns org.deeplearning4j.nn.layers.recurrent.LSTM
...
(defn ->lstm
  ...
  (^LSTM [^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^org.nd4j.linalg.api.ndarray.INDArray input]
    (new LSTM conf input))
  (^LSTM [^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf]
    (new LSTM conf)))
...
(defn feed-forward-mask-array
  ...
  (^org.nd4j.linalg.primitives.Pair [^LSTM this ^org.nd4j.linalg.api.ndarray.INDArray mask-array ^org.deeplearning4j.nn.api.MaskState current-mask-state ^Integer minibatch-size]
...
(defn activate
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^LSTM this ^org.nd4j.linalg.api.ndarray.INDArray input ^Boolean training ^org.deeplearning4j.nn.workspace.LayerWorkspaceMgr workspace-mgr]
    (-> this (.activate input training workspace-mgr)))
  (^org.nd4j.linalg.api.ndarray.INDArray [^LSTM this ^Boolean training ^org.deeplearning4j.nn.workspace.LayerWorkspaceMgr workspace-mgr]
...
(defn backprop-gradient
  ...
  (^org.nd4j.linalg.primitives.Pair [^LSTM this ^org.nd4j.linalg.api.ndarray.INDArray epsilon ^org.deeplearning4j.nn.workspace.LayerWorkspaceMgr workspace-mgr]
...
(defn type
  ...
  (^org.deeplearning4j.nn.api.Layer$Type [^LSTM this]
    (-> this (.type))))
...
(defn rnn-time-step
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^LSTM this ^org.nd4j.linalg.api.ndarray.INDArray input ^org.deeplearning4j.nn.workspace.LayerWorkspaceMgr workspace-mgr]
...
(defn rnn-activate-using-stored-state
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^LSTM this ^org.nd4j.linalg.api.ndarray.INDArray input ^Boolean training ^Boolean store-last-for-tbptt ^org.deeplearning4j.nn.workspace.LayerWorkspaceMgr workspace-mgr]
...
(defn tbptt-backprop-gradient
  ...
  (^org.nd4j.linalg.primitives.Pair [^LSTM this ^org.nd4j.linalg.api.ndarray.INDArray epsilon ^Integer tbptt-backward-length ^org.deeplearning4j.nn.workspace.LayerWorkspaceMgr workspace-mgr]
