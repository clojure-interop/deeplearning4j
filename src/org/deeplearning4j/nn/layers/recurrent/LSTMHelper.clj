(ns org.deeplearning4j.nn.layers.recurrent.LSTMHelper
...
(defn check-supported
  ...
  returns: `boolean`"
  (^Boolean [^LSTMHelper this ^org.nd4j.linalg.activations.IActivation gate-activation-fn ^org.nd4j.linalg.activations.IActivation activation-fn ^Boolean has-peephole-connections]
