(ns org.deeplearning4j.nn.params.DepthwiseConvolutionParamInitializer
...
(defn ->depthwise-convolution-param-initializer
  "Constructor."
...
(def *-weight-key
  ...
  DepthwiseConvolutionParamInitializer/WEIGHT_KEY)

(def *-bias-key
  "Static Constant.

  type: java.lang.String"
  DepthwiseConvolutionParamInitializer/BIAS_KEY)

(defn *get-instance
  "returns: `org.deeplearning4j.nn.params.DepthwiseConvolutionParamInitializer`"
  (^org.deeplearning4j.nn.params.DepthwiseConvolutionParamInitializer []
    (DepthwiseConvolutionParamInitializer/getInstance )))

(defn num-params
  "conf - `org.deeplearning4j.nn.conf.NeuralNetConfiguration`

  returns: `long`"
  (^Long [^DepthwiseConvolutionParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf]
    (-> this (.numParams conf))))
...
(defn param-keys
  ...
  (^java.util.List [^DepthwiseConvolutionParamInitializer this ^org.deeplearning4j.nn.conf.layers.Layer layer]
...
(defn weight-param?
  ...
  (^Boolean [^DepthwiseConvolutionParamInitializer this ^org.deeplearning4j.nn.conf.layers.Layer layer ^java.lang.String key]
...
(defn init
  ...
  (^java.util.Map [^DepthwiseConvolutionParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^org.nd4j.linalg.api.ndarray.INDArray params-view ^Boolean initialize-params]
...
(defn get-gradients-from-flattened
  ...
  (^java.util.Map [^DepthwiseConvolutionParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^org.nd4j.linalg.api.ndarray.INDArray gradient-view]
