(ns org.deeplearning4j.nn.params.GravesLSTMParamInitializer
...
(defn ->graves-lstm-param-initializer
  "Constructor."
  (^GravesLSTMParamInitializer []
    (new GravesLSTMParamInitializer )))
...
(defn *get-instance
  "returns: `org.deeplearning4j.nn.params.GravesLSTMParamInitializer`"
  (^org.deeplearning4j.nn.params.GravesLSTMParamInitializer []
    (GravesLSTMParamInitializer/getInstance )))

(defn num-params
  "conf - `org.deeplearning4j.nn.conf.NeuralNetConfiguration`

  returns: `long`"
  (^Long [^GravesLSTMParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf]
    (-> this (.numParams conf))))
...
(defn param-keys
  ...
  (^java.util.List [^GravesLSTMParamInitializer this ^org.deeplearning4j.nn.conf.layers.Layer layer]
...
(defn weight-param?
  ...
  (^Boolean [^GravesLSTMParamInitializer this ^org.deeplearning4j.nn.conf.layers.Layer layer ^java.lang.String key]
...
(defn init
  ...
  (^java.util.Map [^GravesLSTMParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^org.nd4j.linalg.api.ndarray.INDArray params-view ^Boolean initialize-params]
...
(defn get-gradients-from-flattened
  ...
  (^java.util.Map [^GravesLSTMParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^org.nd4j.linalg.api.ndarray.INDArray gradient-view]
