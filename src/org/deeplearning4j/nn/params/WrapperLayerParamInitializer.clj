(ns org.deeplearning4j.nn.params.WrapperLayerParamInitializer
  (:refer-clojure :only [require comment defn ->])
  (:import [org.deeplearning4j.nn.params WrapperLayerParamInitializer]))

(defn *get-instance
  "returns: `org.deeplearning4j.nn.params.WrapperLayerParamInitializer`"
  (^org.deeplearning4j.nn.params.WrapperLayerParamInitializer []
    (WrapperLayerParamInitializer/getInstance )))

(defn num-params
  "conf - `org.deeplearning4j.nn.conf.NeuralNetConfiguration`

  returns: `long`"
  (^Long [^WrapperLayerParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf]
    (-> this (.numParams conf))))
...
(defn param-keys
  ...
  (^java.util.List [^WrapperLayerParamInitializer this ^org.deeplearning4j.nn.conf.layers.Layer layer]
...
(defn weight-param?
  ...
  (^Boolean [^WrapperLayerParamInitializer this ^org.deeplearning4j.nn.conf.layers.Layer layer ^java.lang.String key]
...
(defn init
  ...
  (^java.util.Map [^WrapperLayerParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^org.nd4j.linalg.api.ndarray.INDArray params-view ^Boolean initialize-params]
...
(defn get-gradients-from-flattened
  ...
  (^java.util.Map [^WrapperLayerParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^org.nd4j.linalg.api.ndarray.INDArray gradient-view]
