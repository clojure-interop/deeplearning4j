(ns org.deeplearning4j.nn.params.PReLUParamInitializer
...
(defn ->p-re-lu-param-initializer
  "Constructor.

  shape - `long[]`
  shared-axes - `long[]`"
  (^PReLUParamInitializer [shape shared-axes]
    (new PReLUParamInitializer shape shared-axes)))

(def *-weight-key
  "Static Constant.

  type: java.lang.String"
  PReLUParamInitializer/WEIGHT_KEY)

(defn *get-instance
  "shape - `long[]`
  shared-axes - `long[]`

  returns: `org.deeplearning4j.nn.params.PReLUParamInitializer`"
  (^org.deeplearning4j.nn.params.PReLUParamInitializer [shape shared-axes]
    (PReLUParamInitializer/getInstance shape shared-axes)))

(defn num-params
  "conf - `org.deeplearning4j.nn.conf.NeuralNetConfiguration`

  returns: `long`"
  (^Long [^PReLUParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf]
    (-> this (.numParams conf))))
...
(defn param-keys
  ...
  (^java.util.List [^PReLUParamInitializer this ^org.deeplearning4j.nn.conf.layers.Layer layer]
...
(defn weight-param?
  ...
  (^Boolean [^PReLUParamInitializer this ^org.deeplearning4j.nn.conf.layers.Layer layer ^java.lang.String key]
...
(defn init
  ...
  (^java.util.Map [^PReLUParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^org.nd4j.linalg.api.ndarray.INDArray params-view ^Boolean initialize-params]
...
(defn get-gradients-from-flattened
  ...
  (^java.util.Map [^PReLUParamInitializer this ^org.deeplearning4j.nn.conf.NeuralNetConfiguration conf ^org.nd4j.linalg.api.ndarray.INDArray gradient-view]
