(ns org.deeplearning4j.datasets.iterator.BaseDatasetIterator
...
(defn ->base-dataset-iterator
  ...
  batch - `int`
  num-examples - `int`
  fetcher - `org.nd4j.linalg.dataset.api.iterator.fetcher.BaseDataFetcher`"
  (^BaseDatasetIterator [^Integer batch ^Integer num-examples ^org.nd4j.linalg.dataset.api.iterator.fetcher.BaseDataFetcher fetcher]
