(ns org.deeplearning4j.models.sequencevectors.graph.primitives.IGraph
...
(defn get-vertex
  ...
  (^org.deeplearning4j.models.sequencevectors.graph.primitives.Vertex [^IGraph this ^Integer idx]
    (-> this (.getVertex idx))))
...
(defn get-random-connected-vertex
  ...
  (^org.deeplearning4j.models.sequencevectors.graph.primitives.Vertex [^IGraph this ^Integer vertex ^java.util.Random rng]
...
(defn add-edge
  ...
  ([^IGraph this ^org.deeplearning4j.models.sequencevectors.graph.primitives.Edge edge]
    (-> this (.addEdge edge))))
