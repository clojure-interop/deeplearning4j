(ns org.deeplearning4j.parallelism.factory.DefaultTrainerContext
...
(defn ->default-trainer-context
  "Constructor."
  (^DefaultTrainerContext []
    (new DefaultTrainerContext )))
...
(defn init
  ...
  ([^DefaultTrainerContext this ^org.deeplearning4j.nn.api.Model model ^java.lang.Object args]
...
(defn finalize-round
  ...
  ([^DefaultTrainerContext this ^org.deeplearning4j.nn.api.Model original-model ^org.deeplearning4j.nn.api.Model models]
