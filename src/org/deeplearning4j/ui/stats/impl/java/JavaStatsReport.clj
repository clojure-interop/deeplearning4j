...
(defn has-histograms?
  ...
  returns: `boolean`"
  (^Boolean [^JavaStatsReport this ^org.deeplearning4j.ui.stats.api.StatsType stats-type]
...
(defn get-data-set-meta-data
  ...
  (^java.util.List [^JavaStatsReport this]
...
(defn report-data-set-meta-data
  ...
  ([^JavaStatsReport this ^java.util.List data-set-meta-data ^java.lang.Class meta-data-class]
...
(defn report-memory-use
  ...
  ([^JavaStatsReport this ^Long jvm-current-bytes ^Long jvm-max-bytes ^Long off-heap-current-bytes ^Long off-heap-max-bytes device-current-bytes device-max-bytes]
...
(defn report-histograms
  ...
  ([^JavaStatsReport this ^org.deeplearning4j.ui.stats.api.StatsType stats-type ^java.util.Map histogram]
...
(defn report-learning-rates
  ...
  ([^JavaStatsReport this ^java.util.Map learning-rates-by-param]
...
(defn has-summary-stats?
  ...
  returns: `boolean`"
  (^Boolean [^JavaStatsReport this ^org.deeplearning4j.ui.stats.api.StatsType stats-type ^org.deeplearning4j.ui.stats.api.SummaryType summary-type]
...
(defn get-stdev
  ...
  (^java.util.Map [^JavaStatsReport this ^org.deeplearning4j.ui.stats.api.StatsType stats-type]
...
(defn report-i-ds
  ...
  time-stamp - `long`"
  ([^JavaStatsReport this ^java.lang.String session-id ^java.lang.String type-id ^java.lang.String worker-id ^Long time-stamp]
...
(defn report-stats-collection-duration-ms
  ...
  ([^JavaStatsReport this ^Integer stats-collection-duration-ms]
...
(defn report-garbage-collection
  ...
  ([^JavaStatsReport this ^java.lang.String gc-name ^Integer delta-gc-count ^Integer delta-gc-time]
...
(defn get-data-set-meta-data-class-name
  ...
  (^java.lang.String [^JavaStatsReport this]
...
(defn report-score
  ...
  ([^JavaStatsReport this ^Double current-score]
...
(defn report-iteration-count
  ...
  iteration-count - `int`"
  ([^JavaStatsReport this ^Integer iteration-count]
...
(defn report-performance
  ...
  ([^JavaStatsReport this ^Long total-runtime-ms ^Long total-examples ^Long total-minibatches ^Double examples-per-second ^Double minibatches-per-second]
...
(defn report-stdev
  ...
  ([^JavaStatsReport this ^org.deeplearning4j.ui.stats.api.StatsType stats-type ^java.util.Map stdev]
...
(defn get-learning-rates
  ...
  (^java.util.Map [^JavaStatsReport this]
...
(defn report-mean
  ...
  ([^JavaStatsReport this ^org.deeplearning4j.ui.stats.api.StatsType stats-type ^java.util.Map mean]
...
(defn encode
  ...
  ([^JavaStatsReport this ^java.nio.ByteBuffer buffer]
    (-> this (.encode buffer)))
  ([^JavaStatsReport this]
    (-> this (.encode))))
...
(defn report-mean-magnitudes
  ...
  ([^JavaStatsReport this ^org.deeplearning4j.ui.stats.api.StatsType stats-type ^java.util.Map mean-magnitudes]
