(ns org.deeplearning4j.ui.storage.sqlite.J7FileStatsStorage
  "A Java 7 compatible file-based StatsStorage implementation, based on SQLite.
...
(defn ->j-7-file-stats-storage
  "Constructor.

  file - Storage location for the stats - `java.io.File`"
  (^J7FileStatsStorage [^java.io.File file]
    (new J7FileStatsStorage file)))
...
(defn list-worker-i-ds-for-session-and-type
  ...
  (^java.util.List [^J7FileStatsStorage this ^java.lang.String session-id ^java.lang.String type-id]
...
(defn put-static-info
  ...
  ([^J7FileStatsStorage this ^org.deeplearning4j.api.storage.Persistable static-info]
...
(defn get-num-update-records-for
  ...
  (^Integer [^J7FileStatsStorage this ^java.lang.String session-id ^java.lang.String type-id ^java.lang.String worker-id]
    (-> this (.getNumUpdateRecordsFor session-id type-id worker-id)))
  (^Integer [^J7FileStatsStorage this ^java.lang.String session-id]
...
(defn get-all-update-times
  ...
  ([^J7FileStatsStorage this ^java.lang.String session-id ^java.lang.String type-id ^java.lang.String worker-id]
...
(defn register-stats-storage-listener
  ...
  ([^J7FileStatsStorage this ^org.deeplearning4j.api.storage.StatsStorageListener listener]
...
(defn list-type-i-ds-for-session
  ...
  (^java.util.List [^J7FileStatsStorage this ^java.lang.String session-id]
    (-> this (.listTypeIDsForSession session-id))))

(defn to-string
  "returns: `java.lang.String`"
  (^java.lang.String [^J7FileStatsStorage this]
    (-> this (.toString))))

(defn remove-all-listeners
  "Description copied from interface: StatsStorage"
  ([^J7FileStatsStorage this]
    (-> this (.removeAllListeners))))

(defn closed?
  "returns: Whether the StatsStorage implementation has been closed or not - `boolean`"
  (^Boolean [^J7FileStatsStorage this]
    (-> this (.isClosed))))
...
(defn get-latest-update
  ...
  (^org.deeplearning4j.api.storage.Persistable [^J7FileStatsStorage this ^java.lang.String session-id ^java.lang.String type-id ^java.lang.String worker-id]
...
(defn put-storage-meta-data
  ...
  ([^J7FileStatsStorage this ^org.deeplearning4j.api.storage.StorageMetaData storage-meta-data]
...
(defn get-all-updates-after
  ...
  (^java.util.List [^J7FileStatsStorage this ^java.lang.String session-id ^java.lang.String type-id ^java.lang.String worker-id ^Long timestamp]
    (-> this (.getAllUpdatesAfter session-id type-id worker-id timestamp)))
  (^java.util.List [^J7FileStatsStorage this ^java.lang.String session-id ^java.lang.String type-id ^Long timestamp]
...
(defn get-update
  ...
  (^org.deeplearning4j.api.storage.Persistable [^J7FileStatsStorage this ^java.lang.String session-id ^java.lang.String type-id ^java.lang.String worker-id ^Long timestamp]
...
(defn list-session-i-ds
  ...
  (^java.util.List [^J7FileStatsStorage this]
    (-> this (.listSessionIDs))))
...
(defn session-exists
  ...
  (^Boolean [^J7FileStatsStorage this ^java.lang.String session-id]
...
(defn put-update
  ...
  ([^J7FileStatsStorage this ^org.deeplearning4j.api.storage.Persistable update]
...
(defn get-storage-meta-data
  ...
  (^org.deeplearning4j.api.storage.StorageMetaData [^J7FileStatsStorage this ^java.lang.String session-id ^java.lang.String type-id]
...
(defn get-updates
  ...
  (^java.util.List [^J7FileStatsStorage this ^java.lang.String session-id ^java.lang.String type-id ^java.lang.String worker-id timestamps]
