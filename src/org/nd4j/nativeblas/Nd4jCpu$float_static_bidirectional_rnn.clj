(ns org.nd4j.nativeblas.Nd4jCpu$float_static_bidirectional_rnn
 ...
 2: cell final non-zero output for backward RNN [batchSize x numUnitsBW]"
  ...
  (:import [org.nd4j.nativeblas Nd4jCpu$float_static_bidirectional_rnn]))

(defn ->float-static-bidirectional-rnn
  "Constructor.

  Pointer cast constructor. Invokes Pointer.Pointer(Pointer).

  p - `org.bytedeco.javacpp.Pointer`"
  (^Nd4jCpu$float_static_bidirectional_rnn [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$float_static_bidirectional_rnn p))
  (^Nd4jCpu$float_static_bidirectional_rnn []
    (new Nd4jCpu$float_static_bidirectional_rnn )))

(defn position
  "position - `long`

  returns: `org.nd4j.nativeblas.Nd4jCpu$float_static_bidirectional_rnn`"
  (^org.nd4j.nativeblas.Nd4jCpu$float_static_bidirectional_rnn [^Nd4jCpu$float_static_bidirectional_rnn this ^Long position]
...
(defn calculate-output-shape
  ...
  (^org.nd4j.nativeblas.Nd4jCpu$ShapeList [^Nd4jCpu$float_static_bidirectional_rnn this ^org.nd4j.nativeblas.Nd4jCpu$ShapeList input-shape ^org.nd4j.nativeblas.Nd4jCpu$FloatContext block]
