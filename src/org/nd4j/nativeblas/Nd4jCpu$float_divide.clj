(ns org.nd4j.nativeblas.Nd4jCpu$float_divide
 ...
 This operation returns Z = Divide(X, Y)"
  ...
  (:import [org.nd4j.nativeblas Nd4jCpu$float_divide]))
...
(defn ->float-divide
  ...
  (^Nd4jCpu$float_divide [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$float_divide p))
  (^Nd4jCpu$float_divide []
    (new Nd4jCpu$float_divide )))

(defn position
  "position - `long`

  returns: `org.nd4j.nativeblas.Nd4jCpu$float_divide`"
  (^org.nd4j.nativeblas.Nd4jCpu$float_divide [^Nd4jCpu$float_divide this ^Long position]
