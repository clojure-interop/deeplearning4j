(ns org.nd4j.nativeblas.Nd4jCpu$float_reversemod
 ...
 This operation returns Z = ReverseMod(X, Y) == Mod(Y, X)"
  ...
  (:import [org.nd4j.nativeblas Nd4jCpu$float_reversemod]))

(defn ->float-reversemod
  "Constructor.

  Pointer cast constructor. Invokes Pointer.Pointer(Pointer).

  p - `org.bytedeco.javacpp.Pointer`"
  (^Nd4jCpu$float_reversemod [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$float_reversemod p))
  (^Nd4jCpu$float_reversemod []
    (new Nd4jCpu$float_reversemod )))

(defn position
  "position - `long`

  returns: `org.nd4j.nativeblas.Nd4jCpu$float_reversemod`"
  (^org.nd4j.nativeblas.Nd4jCpu$float_reversemod [^Nd4jCpu$float_reversemod this ^Long position]
