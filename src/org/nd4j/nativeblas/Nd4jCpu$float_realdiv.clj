(ns org.nd4j.nativeblas.Nd4jCpu$float_realdiv
 ...
 This operation returns Z = Divide(X, Y)"
  ...
  (:import [org.nd4j.nativeblas Nd4jCpu$float_realdiv]))
...
(defn ->float-realdiv
  ...
  (^Nd4jCpu$float_realdiv [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$float_realdiv p))
  (^Nd4jCpu$float_realdiv []
    (new Nd4jCpu$float_realdiv )))

(defn position
  "position - `long`

  returns: `org.nd4j.nativeblas.Nd4jCpu$float_realdiv`"
  (^org.nd4j.nativeblas.Nd4jCpu$float_realdiv [^Nd4jCpu$float_realdiv this ^Long position]
