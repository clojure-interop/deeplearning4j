(ns org.nd4j.nativeblas.Nd4jCpu$float_sru_bp
 ...
 3: 2d, tensor of state gradients [bS x K]"
  ...
  (:import [org.nd4j.nativeblas Nd4jCpu$float_sru_bp]))
...
(defn ->float-sru-bp
  ...
  (^Nd4jCpu$float_sru_bp [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$float_sru_bp p))
  (^Nd4jCpu$float_sru_bp []
    (new Nd4jCpu$float_sru_bp )))

(defn position
  "position - `long`

  returns: `org.nd4j.nativeblas.Nd4jCpu$float_sru_bp`"
  (^org.nd4j.nativeblas.Nd4jCpu$float_sru_bp [^Nd4jCpu$float_sru_bp this ^Long position]
...
(defn calculate-output-shape
  ...
  (^org.nd4j.nativeblas.Nd4jCpu$ShapeList [^Nd4jCpu$float_sru_bp this ^org.nd4j.nativeblas.Nd4jCpu$ShapeList input-shape ^org.nd4j.nativeblas.Nd4jCpu$FloatContext block]
