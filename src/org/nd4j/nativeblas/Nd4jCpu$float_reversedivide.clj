(ns org.nd4j.nativeblas.Nd4jCpu$float_reversedivide
 ...
 This operation returns Z = Divide(Y, x)"
  ...
  (:import [org.nd4j.nativeblas Nd4jCpu$float_reversedivide]))

(defn ->float-reversedivide
  "Constructor.

  Pointer cast constructor. Invokes Pointer.Pointer(Pointer).

  p - `org.bytedeco.javacpp.Pointer`"
  (^Nd4jCpu$float_reversedivide [^org.bytedeco.javacpp.Pointer p]
    (new Nd4jCpu$float_reversedivide p))
  (^Nd4jCpu$float_reversedivide []
    (new Nd4jCpu$float_reversedivide )))

(defn position
  "position - `long`

  returns: `org.nd4j.nativeblas.Nd4jCpu$float_reversedivide`"
  (^org.nd4j.nativeblas.Nd4jCpu$float_reversedivide [^Nd4jCpu$float_reversedivide this ^Long position]
