(ns org.nd4j.jita.allocator.concurrency.RRWLock
  "Lock implementation based on ReentrantReadWriteLock"
  (:refer-clojure :only [require comment defn ->])
  (:import [org.nd4j.jita.allocator.concurrency RRWLock]))
...
(defn object-read-unlock
  ...
  ([^RRWLock this ^java.lang.Object object]
...
(defn shape-read-lock
  ...
  ([^RRWLock this ^java.lang.Object object ^org.nd4j.jita.allocator.impl.AllocationShape shape]
