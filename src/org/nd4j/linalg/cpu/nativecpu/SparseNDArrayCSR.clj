(ns org.nd4j.linalg.cpu.nativecpu.SparseNDArrayCSR
  (:refer-clojure :only [require comment defn ->])
  (:import [org.nd4j.linalg.cpu.nativecpu SparseNDArrayCSR]))

(defn ->sparse-nd-array-csr
  "Constructor.
  ...
  columns - Element i of the integer array columns is the number of the column in A that contains the i-th valuein the values array. - `int[]`
  ...
  (^SparseNDArrayCSR [data columns pointer-b pointer-e shape]
    (new SparseNDArrayCSR data columns pointer-b pointer-e shape)))
...
(defn to-flat-array
  ...
  (^Integer [^SparseNDArrayCSR this ^com.google.flatbuffers.FlatBufferBuilder builder]
...
(defn repeat
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^SparseNDArrayCSR this ^Integer dimension ^Long repeats]
...
(defn mmuli
  ...
  returns: `org.nd4j.linalg.api.ndarray.INDArray`"
  (^org.nd4j.linalg.api.ndarray.INDArray [^SparseNDArrayCSR this ^org.nd4j.linalg.api.ndarray.INDArray other ^org.nd4j.linalg.api.ndarray.INDArray result ^org.nd4j.linalg.api.blas.params.MMulTranspose transpose]
    (-> this (.mmuli other result transpose)))
  (^org.nd4j.linalg.api.ndarray.INDArray [^SparseNDArrayCSR this ^org.nd4j.linalg.api.ndarray.INDArray other ^org.nd4j.linalg.api.blas.params.MMulTranspose transpose]
...
(defn mmul
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^SparseNDArrayCSR this ^org.nd4j.linalg.api.ndarray.INDArray other ^org.nd4j.linalg.api.ndarray.INDArray result ^org.nd4j.linalg.api.blas.params.MMulTranspose m-mul-transpose]
    (-> this (.mmul other result m-mul-transpose)))
  (^org.nd4j.linalg.api.ndarray.INDArray [^SparseNDArrayCSR this ^org.nd4j.linalg.api.ndarray.INDArray other ^org.nd4j.linalg.api.blas.params.MMulTranspose m-mul-transpose]
...
(defn reshape
  ...
  returns: `org.nd4j.linalg.api.ndarray.INDArray`"
  (^org.nd4j.linalg.api.ndarray.INDArray [^SparseNDArrayCSR this ^Character order ^Integer new-shape]
    (-> this (.reshape order new-shape)))
  (^org.nd4j.linalg.api.ndarray.INDArray [^SparseNDArrayCSR this shape]
    (-> this (.reshape shape))))
...
(defn empty?
  ...
  returns: `boolean`"
  (^Boolean [^SparseNDArrayCSR this]
    (-> this (.isEmpty))))

(defn convert-to-doubles
  "returns: `org.nd4j.linalg.api.ndarray.INDArray`"
  (^org.nd4j.linalg.api.ndarray.INDArray [^SparseNDArrayCSR this]
