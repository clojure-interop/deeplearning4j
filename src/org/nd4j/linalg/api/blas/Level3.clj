(ns org.nd4j.linalg.api.blas.Level3
...
(defn gemm
  ...
  ([^Level3 this ^Character order ^Character trans-a ^Character trans-b ^Double alpha ^org.nd4j.linalg.api.ndarray.INDArray a ^org.nd4j.linalg.api.ndarray.INDArray b ^Double beta ^org.nd4j.linalg.api.ndarray.INDArray c]
    (-> this (.gemm order trans-a trans-b alpha a b beta c)))
  ([^Level3 this ^org.nd4j.linalg.api.ndarray.INDArray a ^org.nd4j.linalg.api.ndarray.INDArray b ^org.nd4j.linalg.api.ndarray.INDArray c ^Boolean transpose-a ^Boolean transpose-b ^Double alpha ^Double beta]
...
(defn symm
  ...
  beta - `double`
  c - `org.nd4j.linalg.api.ndarray.INDArray`"
  ([^Level3 this ^Character order ^Character side ^Character uplo ^Double alpha ^org.nd4j.linalg.api.ndarray.INDArray a ^org.nd4j.linalg.api.ndarray.INDArray b ^Double beta ^org.nd4j.linalg.api.ndarray.INDArray c]
...
(defn syrk
  ...
  beta - `double`
  c - `org.nd4j.linalg.api.ndarray.INDArray`"
  ([^Level3 this ^Character order ^Character uplo ^Character trans ^Double alpha ^org.nd4j.linalg.api.ndarray.INDArray a ^Double beta ^org.nd4j.linalg.api.ndarray.INDArray c]
...
(defn syr-2k
  ...
  beta - `double`
  c - `org.nd4j.linalg.api.ndarray.INDArray`"
  ([^Level3 this ^Character order ^Character uplo ^Character trans ^Double alpha ^org.nd4j.linalg.api.ndarray.INDArray a ^org.nd4j.linalg.api.ndarray.INDArray b ^Double beta ^org.nd4j.linalg.api.ndarray.INDArray c]
...
(defn trmm
  ...
  b - `org.nd4j.linalg.api.ndarray.INDArray`
  c - `org.nd4j.linalg.api.ndarray.INDArray`"
  ([^Level3 this ^Character order ^Character side ^Character uplo ^Character trans-a ^Character diag ^Double alpha ^org.nd4j.linalg.api.ndarray.INDArray a ^org.nd4j.linalg.api.ndarray.INDArray b ^org.nd4j.linalg.api.ndarray.INDArray c]
...
(defn trsm
  ...
  a - `org.nd4j.linalg.api.ndarray.INDArray`
  b - `org.nd4j.linalg.api.ndarray.INDArray`"
  ([^Level3 this ^Character order ^Character side ^Character uplo ^Character trans-a ^Character diag ^Double alpha ^org.nd4j.linalg.api.ndarray.INDArray a ^org.nd4j.linalg.api.ndarray.INDArray b]
