(ns org.nd4j.linalg.api.ops.executioner.OpExecutioner
...
(defn calculate-output-shape
  ...
  ([^OpExecutioner this ^org.nd4j.linalg.api.ops.CustomOp op]
    (-> this (.calculateOutputShape op))))

(defn forget-graph
  "id - `long`"
  ([^OpExecutioner this ^Long id]
    (-> this (.forgetGraph id))))
...
(defn get-profiling-mode
  ...
  (^org.nd4j.linalg.api.ops.executioner.OpExecutioner$ProfilingMode [^OpExecutioner this]
...
(defn threshold-encode
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^OpExecutioner this ^org.nd4j.linalg.api.ndarray.INDArray input ^Double threshold ^java.lang.Integer boundary]
    (-> this (.thresholdEncode input threshold boundary)))
  (^org.nd4j.linalg.api.ndarray.INDArray [^OpExecutioner this ^org.nd4j.linalg.api.ndarray.INDArray input ^Double threshold]
...
(defn bitmap-encode
  ...
  returns: `long`"
  (^Long [^OpExecutioner this ^org.nd4j.linalg.api.ndarray.INDArray ind-array ^org.nd4j.linalg.api.ndarray.INDArray target ^Double threshold]
    (-> this (.bitmapEncode ind-array target threshold)))
  (^org.nd4j.linalg.api.ndarray.INDArray [^OpExecutioner this ^org.nd4j.linalg.api.ndarray.INDArray ind-array ^Double threshold]
    (-> this (.bitmapEncode ind-array threshold))))

(defn enable-verbose-mode
  "really-enable - `boolean`"
  ([^OpExecutioner this ^Boolean really-enable]
...
(defn execution-mode
  ...
  (^org.nd4j.linalg.api.ops.executioner.OpExecutioner$ExecutionMode [^OpExecutioner this]
    (-> this (.executionMode))))
...
(defn exec
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^OpExecutioner this ^org.nd4j.linalg.api.ops.impl.accum.Variance accumulation ^Boolean bias-corrected ^Integer dimension]
    (-> this (.exec accumulation bias-corrected dimension)))
  (^org.nd4j.linalg.api.ops.Op [^OpExecutioner this ^org.nd4j.linalg.api.ops.Op op ^Integer dimension]
    (-> this (.exec op dimension)))
  (^org.nd4j.linalg.api.ops.Op [^OpExecutioner this ^org.nd4j.linalg.api.ops.Op op]
    (-> this (.exec op))))
...
(defn bitmap-decode
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^OpExecutioner this ^org.nd4j.linalg.api.ndarray.INDArray encoded ^org.nd4j.linalg.api.ndarray.INDArray target]
...
(defn get-environment-information
  ...
  (^java.util.Properties [^OpExecutioner this]
...
(defn execute-graph
  ...
  (^java.util.Map [^OpExecutioner this ^Long id ^java.util.Map map ^java.util.Map reverse-map]
...
(defn exec-and-return
  ...
  (^org.nd4j.linalg.api.ops.Accumulation [^OpExecutioner this ^org.nd4j.linalg.api.ops.impl.accum.Variance op ^Boolean bias-corrected]
    (-> this (.execAndReturn op bias-corrected)))
  (^org.nd4j.linalg.api.ndarray.INDArray [^OpExecutioner this ^org.nd4j.linalg.api.ops.TransformOp op]
...
(defn set-tad-threshold
  ...
  threshold - `int`"
  ([^OpExecutioner this ^Integer threshold]
...
(defn get-custom-operations
  ...
  (^java.util.Map [^OpExecutioner this]
...
(defn get-tad-manager
  ...
  (^org.nd4j.linalg.cache.TADManager [^OpExecutioner this]
    (-> this (.getTADManager))))
...
(defn set-profiling-mode
  ...
  ([^OpExecutioner this ^org.nd4j.linalg.api.ops.executioner.OpExecutioner$ProfilingMode mode]
...
(defn set-execution-mode
  ...
  ([^OpExecutioner this ^org.nd4j.linalg.api.ops.executioner.OpExecutioner$ExecutionMode execution-mode]
...
(defn type
  ...
  (^org.nd4j.linalg.api.ops.executioner.OpExecutioner$ExecutionerType [^OpExecutioner this]
    (-> this (.type))))
...
(defn get-last-op
  ...
  (^java.lang.String [^OpExecutioner this]
    (-> this (.getLastOp))))
...
(defn register-graph
  ...
  ([^OpExecutioner this ^Long id ^org.bytedeco.javacpp.Pointer graph]
...
(defn iterate-over-all-rows
  ...
  ([^OpExecutioner this ^org.nd4j.linalg.api.ops.Op op]
