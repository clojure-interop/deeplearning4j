(ns org.nd4j.linalg.api.ops.impl.shape.SplitV
  "SplitV op"
...
(defn init-from-tensor-flow
  ...
  ([^SplitV this ^org.tensorflow.framework.NodeDef node-def ^org.nd4j.autodiff.samediff.SameDiff init-with ^java.util.Map attributes-for-node ^org.tensorflow.framework.GraphDef graph]
