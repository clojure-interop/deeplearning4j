...
(defn set-allocation-mode
  ...
  ([^DefaultDataBufferFactory this ^org.nd4j.linalg.api.buffer.DataBuffer$AllocationMode allocation-mode]
...
(defn create-same
  ...
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^org.nd4j.linalg.api.buffer.DataBuffer buffer ^Boolean init ^org.nd4j.linalg.api.memory.MemoryWorkspace workspace]
    (-> this (.createSame buffer init workspace)))
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^org.nd4j.linalg.api.buffer.DataBuffer buffer ^Boolean init]
...
(defn create-double
  ...
  returns: `org.nd4j.linalg.api.buffer.DataBuffer`"
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^Long offset ^java.nio.ByteBuffer buffer ^Integer length]
    (-> this (.createDouble offset buffer length)))
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^Long offset ^Integer length]
    (-> this (.createDouble offset length)))
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^Long length]
...
(defn create-long
  ...
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this data ^Boolean copy]
    (-> this (.createLong data copy)))
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^Long length ^Boolean initialize ^org.nd4j.linalg.api.memory.MemoryWorkspace workspace]
    (-> this (.createLong length initialize workspace)))
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this data]
...
(defn allocation-mode
  ...
  (^org.nd4j.linalg.api.buffer.DataBuffer$AllocationMode [^DefaultDataBufferFactory this]
    (-> this (.allocationMode))))
...
(defn create
  ...
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^org.bytedeco.javacpp.Pointer pointer ^org.nd4j.linalg.api.buffer.DataBuffer$Type type ^Long length ^org.bytedeco.javacpp.indexer.Indexer indexer]
    (-> this (.create pointer type length indexer)))
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^org.nd4j.linalg.api.buffer.DataBuffer underlying-buffer ^Long offset ^Long length]
    (-> this (.create underlying-buffer offset length)))
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^org.bytedeco.javacpp.DoublePointer double-pointer ^Long length]
...
(defn create-half
  ...
  returns: the new buffer - `org.nd4j.linalg.api.buffer.DataBuffer`"
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^Long offset data ^Boolean copy]
    (-> this (.createHalf offset data copy)))
  (^org.nd4j.linalg.api.buffer.DataBuffer [^DefaultDataBufferFactory this ^Long length ^Boolean initialize]
