(ns org.nd4j.linalg.api.rng.distribution.impl.NormalDistribution
  "Base distribution derived from apache commons math
 http://commons.apache.org/proper/commons-math/

 (specifically the NormalDistribution"
...
(defn ->normal-distribution
  ...
  (^NormalDistribution [^org.nd4j.linalg.api.rng.Random rng ^Double mean ^Double sd ^Double inverse-cum-accuracy]
    (new NormalDistribution rng mean sd inverse-cum-accuracy))
...
(defn sample
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^NormalDistribution this shape]
    (-> this (.sample shape)))
  (^Double [^NormalDistribution this]
    (-> this (.sample))))
