(ns org.nd4j.linalg.api.rng.distribution.impl.LogNormalDistribution
...
(defn ->log-normal-distribution
  ...
  (^LogNormalDistribution [^org.nd4j.linalg.api.rng.Random rng ^Double mean ^Double sd ^Double inverse-cum-accuracy]
    (new LogNormalDistribution rng mean sd inverse-cum-accuracy))
  (^LogNormalDistribution [^Double mean ^Double sd ^Double inverse-cum-accuracy]
    (new LogNormalDistribution mean sd inverse-cum-accuracy))
  (^LogNormalDistribution [^Double mean ^Double sd]
    (new LogNormalDistribution mean sd))
...
(defn inverse-cumulative-probability
  ...
  (^Double [^LogNormalDistribution this ^Double p]
...
(defn sample
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^LogNormalDistribution this shape]
    (-> this (.sample shape)))
  (^Double [^LogNormalDistribution this]
    (-> this (.sample))))
