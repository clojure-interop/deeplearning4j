(ns org.nd4j.linalg.lossfunctions.impl.LossHinge
...
(defn op-type
  ...
  (^org.nd4j.linalg.api.ops.Op$Type [^LossHinge this]
    (-> this (.opType))))
...
(defn compute-gradient-and-score
  ...
  (^org.nd4j.linalg.primitives.Pair [^LossHinge this ^org.nd4j.linalg.api.ndarray.INDArray labels ^org.nd4j.linalg.api.ndarray.INDArray pre-output ^org.nd4j.linalg.activations.IActivation activation-fn ^org.nd4j.linalg.api.ndarray.INDArray mask ^Boolean average]
...
(defn op-name
  ...
  (^java.lang.String [^LossHinge this]
    (-> this (.opName))))
...
(defn init-from-onnx
  ...
  ([^LossHinge this ^onnx.OnnxProto3$NodeProto node ^org.nd4j.autodiff.samediff.SameDiff init-with ^java.util.Map attributes-for-node ^onnx.OnnxProto3$GraphProto graph]
...
(defn compute-score
  ...
  returns: `double`"
  (^Double [^LossHinge this ^org.nd4j.linalg.api.ndarray.INDArray labels ^org.nd4j.linalg.api.ndarray.INDArray pre-output ^org.nd4j.linalg.activations.IActivation activation-fn ^org.nd4j.linalg.api.ndarray.INDArray mask ^Boolean average]
...
(defn do-diff
  ...
  (^java.util.List [^LossHinge this ^java.util.List f-1]
    (-> this (.doDiff f-1))))
...
(defn compute-gradient
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^LossHinge this ^org.nd4j.linalg.api.ndarray.INDArray labels ^org.nd4j.linalg.api.ndarray.INDArray pre-output ^org.nd4j.linalg.activations.IActivation activation-fn ^org.nd4j.linalg.api.ndarray.INDArray mask]
...
(defn output-variables
  ...
  ([^LossHinge this ^java.lang.String base-name]
...
(defn init-from-tensor-flow
  ...
  ([^LossHinge this ^org.tensorflow.framework.NodeDef node-def ^org.nd4j.autodiff.samediff.SameDiff init-with ^java.util.Map attributes-for-node ^org.tensorflow.framework.GraphDef graph]
