(ns org.nd4j.linalg.lossfunctions.impl.LossKLD
...
(defn op-type
  ...
  (^org.nd4j.linalg.api.ops.Op$Type [^LossKLD this]
    (-> this (.opType))))
...
(defn compute-gradient-and-score
  ...
  (^org.nd4j.linalg.primitives.Pair [^LossKLD this ^org.nd4j.linalg.api.ndarray.INDArray labels ^org.nd4j.linalg.api.ndarray.INDArray pre-output ^org.nd4j.linalg.activations.IActivation activation-fn ^org.nd4j.linalg.api.ndarray.INDArray mask ^Boolean average]
...
(defn init-from-onnx
  ...
  ([^LossKLD this ^onnx.OnnxProto3$NodeProto node ^org.nd4j.autodiff.samediff.SameDiff init-with ^java.util.Map attributes-for-node ^onnx.OnnxProto3$GraphProto graph]
...
(defn compute-score
  ...
  returns: `double`"
  (^Double [^LossKLD this ^org.nd4j.linalg.api.ndarray.INDArray labels ^org.nd4j.linalg.api.ndarray.INDArray pre-output ^org.nd4j.linalg.activations.IActivation activation-fn ^org.nd4j.linalg.api.ndarray.INDArray mask ^Boolean average]
...
(defn do-diff
  ...
  (^java.util.List [^LossKLD this ^java.util.List f-1]
    (-> this (.doDiff f-1))))
...
(defn compute-gradient
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^LossKLD this ^org.nd4j.linalg.api.ndarray.INDArray labels ^org.nd4j.linalg.api.ndarray.INDArray pre-output ^org.nd4j.linalg.activations.IActivation activation-fn ^org.nd4j.linalg.api.ndarray.INDArray mask]
...
(defn output-variables
  ...
  ([^LossKLD this ^java.lang.String base-name]
...
(defn init-from-tensor-flow
  ...
  ([^LossKLD this ^org.tensorflow.framework.NodeDef node-def ^org.nd4j.autodiff.samediff.SameDiff init-with ^java.util.Map attributes-for-node ^org.tensorflow.framework.GraphDef graph]
