...
(defn op-type
  ...
  (^org.nd4j.linalg.api.ops.Op$Type [^LossCosineProximity this]
    (-> this (.opType))))
...
(defn compute-gradient-and-score
  ...
  (^org.nd4j.linalg.primitives.Pair [^LossCosineProximity this ^org.nd4j.linalg.api.ndarray.INDArray labels ^org.nd4j.linalg.api.ndarray.INDArray pre-output ^org.nd4j.linalg.activations.IActivation activation-fn ^org.nd4j.linalg.api.ndarray.INDArray mask ^Boolean average]
...
(defn op-name
  ...
  (^java.lang.String [^LossCosineProximity this]
    (-> this (.opName))))
...
(defn init-from-onnx
  ...
  ([^LossCosineProximity this ^onnx.OnnxProto3$NodeProto node ^org.nd4j.autodiff.samediff.SameDiff init-with ^java.util.Map attributes-for-node ^onnx.OnnxProto3$GraphProto graph]
...
(defn compute-score
  ...
  returns: `double`"
  (^Double [^LossCosineProximity this ^org.nd4j.linalg.api.ndarray.INDArray labels ^org.nd4j.linalg.api.ndarray.INDArray pre-output ^org.nd4j.linalg.activations.IActivation activation-fn ^org.nd4j.linalg.api.ndarray.INDArray mask ^Boolean average]
...
(defn do-diff
  ...
  (^java.util.List [^LossCosineProximity this ^java.util.List f-1]
    (-> this (.doDiff f-1))))
...
(defn compute-gradient
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^LossCosineProximity this ^org.nd4j.linalg.api.ndarray.INDArray labels ^org.nd4j.linalg.api.ndarray.INDArray pre-output ^org.nd4j.linalg.activations.IActivation activation-fn ^org.nd4j.linalg.api.ndarray.INDArray mask]
...
(defn output-variables
  ...
  ([^LossCosineProximity this ^java.lang.String base-name]
    (-> this (.outputVariables base-name)))
  ([^LossCosineProximity this]
...
(defn init-from-tensor-flow
  ...
  ([^LossCosineProximity this ^org.tensorflow.framework.NodeDef node-def ^org.nd4j.autodiff.samediff.SameDiff init-with ^java.util.Map attributes-for-node ^org.tensorflow.framework.GraphDef graph]
