(ns org.nd4j.linalg.activations.impl.ActivationReLU
  "f(x) = max(0, x)"
  (:refer-clojure :only [require comment defn ->])
  (:import [org.nd4j.linalg.activations.impl ActivationReLU]))

(defn ->activation-re-lu
  "Constructor."
  (^ActivationReLU []
    (new ActivationReLU )))
...
(defn get-activation
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^ActivationReLU this ^org.nd4j.linalg.api.ndarray.INDArray in ^Boolean training]
...
(defn backprop
  ...
  (^org.nd4j.linalg.primitives.Pair [^ActivationReLU this ^org.nd4j.linalg.api.ndarray.INDArray in ^org.nd4j.linalg.api.ndarray.INDArray epsilon]
    (-> this (.backprop in epsilon))))

(defn to-string
  "returns: `java.lang.String`"
  (^java.lang.String [^ActivationReLU this]
    (-> this (.toString))))
