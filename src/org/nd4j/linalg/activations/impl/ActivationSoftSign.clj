(ns org.nd4j.linalg.activations.impl.ActivationSoftSign
  "f_i(x) = x_i / (1+|x_i|)"
  (:refer-clojure :only [require comment defn ->])
  (:import [org.nd4j.linalg.activations.impl ActivationSoftSign]))

(defn ->activation-soft-sign
  "Constructor."
  (^ActivationSoftSign []
...
(defn get-activation
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^ActivationSoftSign this ^org.nd4j.linalg.api.ndarray.INDArray in ^Boolean training]
...
(defn backprop
  ...
  (^org.nd4j.linalg.primitives.Pair [^ActivationSoftSign this ^org.nd4j.linalg.api.ndarray.INDArray in ^org.nd4j.linalg.api.ndarray.INDArray epsilon]
    (-> this (.backprop in epsilon))))

(defn to-string
  "returns: `java.lang.String`"
  (^java.lang.String [^ActivationSoftSign this]
    (-> this (.toString))))
