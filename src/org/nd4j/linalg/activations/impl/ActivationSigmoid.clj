(ns org.nd4j.linalg.activations.impl.ActivationSigmoid
  "f(x) = 1 / (1  exp(-x))"
  (:refer-clojure :only [require comment defn ->])
  (:import [org.nd4j.linalg.activations.impl ActivationSigmoid]))

(defn ->activation-sigmoid
  "Constructor."
  (^ActivationSigmoid []
...
(defn get-activation
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^ActivationSigmoid this ^org.nd4j.linalg.api.ndarray.INDArray in ^Boolean training]
...
(defn backprop
  ...
  (^org.nd4j.linalg.primitives.Pair [^ActivationSigmoid this ^org.nd4j.linalg.api.ndarray.INDArray in ^org.nd4j.linalg.api.ndarray.INDArray epsilon]
    (-> this (.backprop in epsilon))))

(defn to-string
  "returns: `java.lang.String`"
  (^java.lang.String [^ActivationSigmoid this]
    (-> this (.toString))))
