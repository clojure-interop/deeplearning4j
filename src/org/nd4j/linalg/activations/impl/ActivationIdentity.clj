(ns org.nd4j.linalg.activations.impl.ActivationIdentity
  "f(x) = x"
  (:refer-clojure :only [require comment defn ->])
  (:import [org.nd4j.linalg.activations.impl ActivationIdentity]))

(defn ->activation-identity
  "Constructor."
  (^ActivationIdentity []
...
(defn get-activation
  ...
  (^org.nd4j.linalg.api.ndarray.INDArray [^ActivationIdentity this ^org.nd4j.linalg.api.ndarray.INDArray in ^Boolean training]
...
(defn backprop
  ...
  (^org.nd4j.linalg.primitives.Pair [^ActivationIdentity this ^org.nd4j.linalg.api.ndarray.INDArray in ^org.nd4j.linalg.api.ndarray.INDArray epsilon]
    (-> this (.backprop in epsilon))))

(defn to-string
  "returns: `java.lang.String`"
  (^java.lang.String [^ActivationIdentity this]
    (-> this (.toString))))
