(ns onnx.OnnxMlProto3$TensorProtoOrBuilder
  (:refer-clojure :only [require comment defn ->])
  (:import [onnx OnnxMlProto3$TensorProtoOrBuilder]))
...
(defn get-uint-64-data-list
  ...
  (^java.util.List [^OnnxMlProto3$TensorProtoOrBuilder this]
...
(defn get-int-32-data-count
  ...
  returns: `int`"
  (^Integer [^OnnxMlProto3$TensorProtoOrBuilder this]
...
(defn get-data-type
  ...
  (^onnx.OnnxMlProto3$TensorProto$DataType [^OnnxMlProto3$TensorProtoOrBuilder this]
    (-> this (.getDataType))))
...
(defn get-double-data
  ...
  returns: `double`"
  (^Double [^OnnxMlProto3$TensorProtoOrBuilder this ^Integer index]
...
(defn get-doc-string-bytes
  ...
  (^com.github.os72.protobuf351.ByteString [^OnnxMlProto3$TensorProtoOrBuilder this]
...
(defn get-doc-string
  ...
  (^java.lang.String [^OnnxMlProto3$TensorProtoOrBuilder this]
    (-> this (.getDocString))))
...
(defn get-segment-or-builder
  ...
  (^onnx.OnnxMlProto3$TensorProto$SegmentOrBuilder [^OnnxMlProto3$TensorProtoOrBuilder this]
...
(defn get-int-32-data
  ...
  returns: `int`"
  (^Integer [^OnnxMlProto3$TensorProtoOrBuilder this ^Integer index]
...
(defn get-uint-64-data
  ...
  returns: `long`"
  (^Long [^OnnxMlProto3$TensorProtoOrBuilder this ^Integer index]
...
(defn get-float-data
  ...
  returns: `float`"
  (^Float [^OnnxMlProto3$TensorProtoOrBuilder this ^Integer index]
...
(defn has-segment?
  ...
  returns: `boolean`"
  (^Boolean [^OnnxMlProto3$TensorProtoOrBuilder this]
    (-> this (.hasSegment))))
...
(defn get-string-data
  ...
  returns: `com.github.os72.protobuf351.ByteString`"
  (^com.github.os72.protobuf351.ByteString [^OnnxMlProto3$TensorProtoOrBuilder this ^Integer index]
...
(defn get-segment
  ...
  (^onnx.OnnxMlProto3$TensorProto$Segment [^OnnxMlProto3$TensorProtoOrBuilder this]
    (-> this (.getSegment))))
