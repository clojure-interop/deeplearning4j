(ns onnx.OnnxMlProto3$NodeProtoOrBuilder
  (:refer-clojure :only [require comment defn ->])
  (:import [onnx OnnxMlProto3$NodeProtoOrBuilder]))
...
(defn get-op-type
  ...
  (^java.lang.String [^OnnxMlProto3$NodeProtoOrBuilder this]
    (-> this (.getOpType))))
...
(defn get-attribute-or-builder
  ...
  (^onnx.OnnxMlProto3$AttributeProtoOrBuilder [^OnnxMlProto3$NodeProtoOrBuilder this ^Integer index]
...
(defn get-doc-string-bytes
  ...
  (^com.github.os72.protobuf351.ByteString [^OnnxMlProto3$NodeProtoOrBuilder this]
...
(defn get-input-count
  ...
  returns: `int`"
  (^Integer [^OnnxMlProto3$NodeProtoOrBuilder this]
    (-> this (.getInputCount))))
...
(defn get-input-bytes
  ...
  returns: `com.github.os72.protobuf351.ByteString`"
  (^com.github.os72.protobuf351.ByteString [^OnnxMlProto3$NodeProtoOrBuilder this ^Integer index]
...
(defn get-input-list
  ...
  (^java.util.List [^OnnxMlProto3$NodeProtoOrBuilder this]
    (-> this (.getInputList))))
...
(defn get-attribute
  ...
  (^onnx.OnnxMlProto3$AttributeProto [^OnnxMlProto3$NodeProtoOrBuilder this ^Integer index]
...
(defn get-input
  ...
  returns: `java.lang.String`"
  (^java.lang.String [^OnnxMlProto3$NodeProtoOrBuilder this ^Integer index]
    (-> this (.getInput index))))
...
(defn get-attribute-or-builder-list
  ...
  ([^OnnxMlProto3$NodeProtoOrBuilder this]
